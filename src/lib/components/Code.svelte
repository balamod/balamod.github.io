<script lang="ts">
  ...
  import bash from 'svelte-highlight/languages/bash';
	...
	export let language: 'typescript' | 'lua' | 'json' | 'rust' | 'glsl' | 'plaintext' | 'bash' = 'plaintext';
...
<div class="code-container">
	<span class="code-header">
		...
		<IconButton on:click={() => copyCode(code.innerText)} class="material-icons"
	...
	{:else}
		<Highlight language={getLanguage()} code={code?.innerText ?? ''} />
	{/if}
</div>
